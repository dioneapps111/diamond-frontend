...
=======
    let temp = [
>>>>>>> 8dc2c6611cac0267d60483b33fcd6df61f0dc089
        {
            type: "",
            kapan: "",
            refno: "",
...
<<<<<<< HEAD
  ...
  const setDataOnChange = (feild, index, value) => {
    ...
    if (mg[index].color !== null || mg[index].color === undefined) {
      // mg[index].color = "";
      mg[index].lotno =
        mg[index].clarity.name + mg[index].shape.name + mg[index].size.name;
    }
    // if (mg[index].clarity === null || mg[index].clarity === undefined) {
    //   mg[index].lotno =
    //     mg[index].color.name +
    //     mg[index].shape.name +
    //     mg[index].size.name;
    // }
    // if (mg[index].shape === null || mg[index].shape === undefined) {
    //   mg[index].lotno =
    //     mg[index].color.name +
    //     mg[index].clarity.name +
    //     mg[index].size.name;
    // }
    // if (mg[index].size === null || mg[index].size === undefined) {
