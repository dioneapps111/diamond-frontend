                  ...
                  <tr key={"lot" + index}>
                    <td>
                      {/* <Dropdown
                        ...
                        editable
                      /> */}
                      <AutoComplete value={selectedCountry2} suggestions={filteredcities} completeMethod={searchCountry} field="name" dropdown forceSelection itemTemplate={itemTemplate} onChange={(e) => setSelectedCountry2(e.value)} aria-label="cities" />
